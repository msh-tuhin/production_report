...
public class DailyReportResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daily_report_result);

        String fullDate = getIntent().getStringExtra("full_date");
